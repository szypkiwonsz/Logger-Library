...
class TestLoggerReader:
    ...
    def test_data_with_s_date_true(self, log_entries_json_data, json_logger_reader):
        with mock.patch("builtins.open", mock.mock_open(read_data=log_entries_json_data), create=True):
    ...
    def test_data_with_s_date_false(self, log_entries_json_data, json_logger_reader):
        with mock.patch("builtins.open", mock.mock_open(read_data=log_entries_json_data), create=True):
    ...
    def test_data_with_e_date_true(self, log_entries_json_data, json_logger_reader):
        with mock.patch("builtins.open", mock.mock_open(read_data=log_entries_json_data), create=True):
    ...
    def test_data_with_e_date_false(self, log_entries_json_data, json_logger_reader):
        with mock.patch("builtins.open", mock.mock_open(read_data=log_entries_json_data), create=True):
            data_with_e_date_false = json_logger_reader.find_by_text('test_msg', end_date=datetime(2020, 7, 31))
        assert data_with_e_date_false == []

    def test_data_with_s_date_and_e_date_true(self, log_entries_json_data, json_logger_reader):
        with mock.patch("builtins.open", mock.mock_open(read_data=log_entries_json_data), create=True):
    ...
    def test_data_with_s_date_and_e_date_false(self, log_entries_json_data, json_logger_reader):
        with mock.patch("builtins.open", mock.mock_open(read_data=log_entries_json_data), create=True):
